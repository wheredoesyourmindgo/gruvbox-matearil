...
const getSyntax = (palette: Palette) => [
  // Syntax{{{
  {
    name: "Regular",
  ...
  },
  {
    name: "Keyword Italic",
    scope:
      "storage.type.enum, storage.type.interface, storage.type.property, keyword.operator.new, keyword.operator.expression, keyword.operator.new, keyword.operator.delete, storage.type.extends, keyword.control.from, storage.modifier, keyword.control.as",
    settings: {
      fontStyle: "italic"
    }
  },
  ...
  },
  {
    name: "Property",
    scope:
      "variable.object.property, support.variable.property, meta.object-literal.key",
    settings: {
      foreground: palette.fg
    }
  },
  {
    name: "Property Italic",
    scope:
      "variable.other.property, variable.other.object.property, variable.other.enummember, variable.other.member",
    settings: {
      foreground: palette.fg,
      fontStyle: "italic"
    }
  ...
  },
  {
    name: "LaTex yellow",
    scope:
      "variable.parameter.latex, variable.parameter.function.latex, variable.parameter.definition.label.latex, constant.other.reference.label.latex",
    settings: {
      foreground: palette.yellow
    }
  },
  ...
  {
    name: "LaTex white",
    scope: "meta.function.environment.general.latex",
    settings: {
      foreground: palette.fg
    }
  },
  ...
  },
  {
    name: "Html green",
    scope:
      "string.quoted.double.html, string.quoted.single.html, punctuation.definition.string.begin.html, punctuation.definition.string.end.html, punctuation.separator.key-value.html, punctuation.definition.string.begin.xml, punctuation.definition.string.end.xml, string.quoted.double.xml, string.quoted.single.xml",
    settings: {
      foreground: palette.green
    }
  },
  ...
  },
  {
    name: "JSX green",
    scope:
      "entity.other.attribute-name.jsx, entity.other.attribute-name.js.jsx",
    settings: {
      foreground: palette.yellow
    }
  },
  ...
  },
  {
    name: "TSX yellow",
    scope:
      "punctuation.definition.tag.directive.js.jsx, entity.other.attribute-name.directive.js.jsx, entity.other.attribute-name.js.jsx",
    settings: {
      foreground: palette.yellow,
      fontStyle: "italic"
    }
  ...
  {
    name: "JSX aqua",
    scope: "entity.name.function.js.jsx",
    settings: {
      foreground: palette.aqua
    }
  },
  ...
  },
  {
    ...
    scope:
      "entity.name.type.ts, entity.name.type.interface.ts, entity.other.inherited-class.ts, entity.name.type.class.ts, entity.name.type.enum.ts, entity.name.type.module.ts, entity.name.type.alias.ts",
    settings: {
      foreground: palette.blue
    }
  },
  ...
  },
  {
    ...
    scope:
      "punctuation.separator.key-value.ts, punctuation.accessor.ts, keyword.control.import.ts, keyword.control.export.ts, storage.modifier.async.ts, keyword.control.flow.ts, keyword.control.trycatch.ts",
    settings: {
      foreground: palette.purple
    }
  },
  ...
  // },
  {
    ...
    scope: [
      ...
      "meta.type.annotation.tsx entity.name.type.tsx"
    ],
    settings: {
      foreground: palette.fg1
    }
  ...
  },
  {
    name: "TSX blue",
    scope:
      "entity.name.type.tsx, support.class.component.tsx, entity.name.type.interface.tsx, entity.other.inherited-class.tsx, entity.name.type.class.tsx, entity.name.type.enum.tsx, entity.name.type.module.tsx, entity.name.type.alias.tsx",
    settings: {
      foreground: palette.blue
    }
  },
  ...
  },
  {
    name: "TSX purple",
    scope:
      "punctuation.separator.key-value.tsx, punctuation.accessor.tsx, keyword.control.import.tsx, keyword.control.export.tsx, storage.modifier.async.tsx, keyword.control.flow.tsx, keyword.control.trycatch.tsx",
    settings: {
      foreground: palette.purple
    }
  },
